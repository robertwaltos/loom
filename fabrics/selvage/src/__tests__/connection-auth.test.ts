...
import type { ConnectionAuthDeps, TokenValidationPort, AuthResult } from '../connection-auth.js';
...
function isSuccess(
  result: AuthResult,
): result is { authenticated: true; dynastyId: string; tokenId: string; sessionId: string } {
...
describe('ConnectionAuthenticator — authentication', () => {
  ...
  it('rejects invalid token', () => {
    const auth = createConnectionAuthenticator(
      makeDeps({
