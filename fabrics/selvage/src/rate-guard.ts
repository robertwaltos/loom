...
function checkImpl(state: GuardState, connectionId: string, action: string): RateGuardResult {
  state.totalChecks += 1;
...
function consumeImpl(state: GuardState, connectionId: string, action: string): RateGuardResult {
  state.totalChecks += 1;
...
function getOrCreateConnection(state: GuardState, connectionId: string): ConnectionState {
...
function resetConnectionImpl(state: GuardState, connectionId: string): boolean {
