...
describe('TransitLedger — queries', () => {
  it('lists by dynasty', () => {
    const ledger = createTransitLedger(makeDeps());
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'a', destinationWorldId: 'b', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'b', destinationWorldId: 'c', durationMicroseconds: 200 });
    ledger.record({ dynastyId: 'dyn-2', originWorldId: 'a', destinationWorldId: 'b', durationMicroseconds: 100 });
  ...
  it('lists by origin world', () => {
    const ledger = createTransitLedger(makeDeps());
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'earth', destinationWorldId: 'mars', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-2', originWorldId: 'earth', destinationWorldId: 'venus', durationMicroseconds: 200 });
    expect(ledger.listByOrigin('earth')).toHaveLength(2);
  });

  it('lists by destination world', () => {
    const ledger = createTransitLedger(makeDeps());
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'a', destinationWorldId: 'mars', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-2', originWorldId: 'b', destinationWorldId: 'mars', durationMicroseconds: 200 });
  ...
  it('counts transits by route', () => {
    ...
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'a', destinationWorldId: 'b', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-2', originWorldId: 'a', destinationWorldId: 'b', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'a', destinationWorldId: 'c', durationMicroseconds: 100 });
...
describe('TransitLedger — stats', () => {
  ...
  it('tracks aggregate stats', () => {
    const ledger = createTransitLedger(makeDeps());
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'a', destinationWorldId: 'b', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-1', originWorldId: 'b', destinationWorldId: 'a', durationMicroseconds: 100 });
    ledger.record({ dynastyId: 'dyn-2', originWorldId: 'a', destinationWorldId: 'b', durationMicroseconds: 100 });
    const stats = ledger.getStats();
