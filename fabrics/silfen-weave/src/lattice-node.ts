...
import { nodeNotFound, nodeAlreadyExists, beaconInvalidStatus } from './weave-errors.js';
...
function deployBeaconImpl(state: RegistryState, nodeId: string, beaconId: string): ResonanceBeacon {
...
function calculateHarmonicOverlap(a: ReadonlyArray<number>, b: ReadonlyArray<number>): number {
