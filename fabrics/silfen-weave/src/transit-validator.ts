...
export function createTransitValidator(deps: TransitValidatorDeps): TransitValidator {
...
export function requiredComponentsRule(required: ReadonlyArray<string>): TransitValidationRule {
  return {
...
function checkWorldCapacity(ctx: ValidationContext): ReadonlyArray<ValidationIssue> {
...
function checkEntityLock(ctx: ValidationContext): ReadonlyArray<ValidationIssue> {
