...
function mapContinuityToDynastyStatus(continuityState: ContinuityState): DynastyStatus | null {
...
function createAuctionForDynasty(state: ContinuityOrchestratorState, dynastyId: string): void {
