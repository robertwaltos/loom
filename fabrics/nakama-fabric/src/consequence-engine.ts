...
export function createConsequenceEngine(deps: ConsequenceEngineDeps): ConsequenceEngine {
  return {
...
function recordSurveyChronicle(deps: ConsequenceEngineDeps, event: SurveyCompleteEvent): string {
...
function notifyWorldSurveyed(deps: ConsequenceEngineDeps, event: SurveyCompleteEvent): void {
...
function handleVote(deps: ConsequenceEngineDeps, event: VoteCompleteEvent): VoteConsequenceResult {
