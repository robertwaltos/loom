...
export function createDynastyBootstrapService(deps: DynastyBootstrapDeps): DynastyBootstrapService {
  return {
...
function bootstrapDynasty(deps: DynastyBootstrapDeps, params: BootstrapParams): BootstrapResult {
...
function createDynastyRecord(deps: DynastyBootstrapDeps, params: BootstrapParams): DynastyInfo {
...
function fundDynastyAccount(deps: DynastyBootstrapDeps, kalonAccountId: string): bigint {
...
function recordBirthInChronicle(deps: DynastyBootstrapDeps, dynasty: DynastyInfo): string {
