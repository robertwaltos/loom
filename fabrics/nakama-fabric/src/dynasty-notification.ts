...
interface DynastyNotificationService {
  ...
  readonly getForDynasty: (dynastyId: string, filter?: NotificationFilter) => readonly NotificationSnapshot[];
...
function createDynastyNotificationService(deps: DynastyNotificationDeps): DynastyNotificationService {
