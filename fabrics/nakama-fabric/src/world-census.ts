...
function registerWorldImpl(state: CensusState, worldId: string, cap: number): boolean {
...
function removeWorldImpl(state: CensusState, worldId: string): boolean {
  return state.worlds.delete(worldId);
}

function addResidentImpl(state: CensusState, params: RegisterResidencyParams): boolean {
...
function removeResidentImpl(state: CensusState, dynastyId: string): boolean {
...
function getPopulationImpl(state: CensusState, worldId: string): WorldPopulation | undefined {
...
function createWorldCensusService(deps: WorldCensusDeps): WorldCensusService {
