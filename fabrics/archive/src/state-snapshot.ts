...
export function createStateSnapshotEngine(deps: StateSnapshotDeps): StateSnapshotEngine {
...
function addToWorldIndex(state: EngineState, worldId: string, snapshotId: string): void {
