...
import { createWorldShadowEconomy, DEFAULT_SHADOW_CONFIG } from '../world-shadow-economy.js';
import type {
  WorldShadowEconomy,
  ShadowEconomyConfig,
  CommodityType,
...
function createTestEconomy(
  ...
  return createWorldShadowEconomy(
    worldId,
    {
...
describe('Shadow economy all commodity types', () => {
  const types: ReadonlyArray<CommodityType> = ['food', 'materials', 'services', 'luxury'];
