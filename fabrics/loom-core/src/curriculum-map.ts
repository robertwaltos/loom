...
const FINANCIAL_ALIGNMENTS: ReadonlyArray<FinancialLiteracyAlignment> = [
  ...
  { worldId: 'entrepreneur-workshop', worldName: "Entrepreneur's Workshop", primaryStandards: 'Jump$tart Coalition — Earning 1-4', framework: 'C3 D2.Eco.8-9', skillsDeveloped: 'Business planning, profit/loss, innovation and risk' },
