...
function updateEntity(store: ComponentStore, entityId: EntityId, deltaSec: number): void {
...
function writeVelocity(store: ComponentStore, entityId: EntityId, velocity: Vec3): void {
