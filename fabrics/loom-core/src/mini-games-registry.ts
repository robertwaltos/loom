...
const MINI_GAMES: ReadonlyArray<MiniGameDefinition> = [
  ...
  { gameId: 'prototype-sprint', worldId: 'entrepreneur-workshop', name: 'Prototype Sprint', mechanic: 'Design, test, and iterate a product with limited resources', learningObjective: 'Design thinking, iteration', realm: 'financial-literacy', maxDifficulty: 5 },
