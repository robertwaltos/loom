...
interface EventSourcingStore {
  ...
  readonly snapshot: <T>(aggregateId: string, reducer: EventReducer<T>, initial: T) => AggregateSnapshot<T>;
...
function rebuildImpl<T>(state: SourcingState, aggregateId: string, reducer: EventReducer<T>, initial: T): T {
...
function snapshotImpl<T>(state: SourcingState, aggregateId: string, reducer: EventReducer<T>, initial: T): AggregateSnapshot<T> {
