...
function createEntityQueryAdapter(source: EntityQuerySourcePort): SelvageEntityQueryPort {
  return {
...
function createComponentQueryAdapter(store: ComponentStore): SelvageComponentQueryPort {
  return {
    getComponents: (entityId: string): Record<string, unknown> => {
...
function buildComponentMap(store: ComponentStore, entityId: EntityId): Record<string, unknown> {
...
function createPlayerEntityAdapter(deps: PlayerEntityAdapterDeps): SelvagePlayerEntityPort {
  return {
...
function createSelvageBroadcastSystem(broadcast: SelvaeBroadcastPort): SystemFn {
