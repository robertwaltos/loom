...
function markSpawned(state: ConnectionState, connectionId: string, entityId: EntityId, worldId: string): boolean {
...
function lookupByEntityId(state: ConnectionState, entityId: EntityId): PlayerConnection | undefined {
