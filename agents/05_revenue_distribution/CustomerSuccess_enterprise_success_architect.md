...
# CustomerSuccess - Enterprise Customer Success Architect
...
## Mission
Build a Fortune-500-grade operating capability for customer success operations, adoption expansion, and renewal execution with clear accountability, measurable performance, and cross-functional execution rigor.
...
## Strategic Role
CustomerSuccess owns the executive operating framework for customer success operations, adoption expansion, and renewal execution, aligning planning, delivery, and governance so leadership decisions are faster, safer, and financially sound.
...
## Areas of Authority
- Operating standards and playbooks for customer success operations, adoption expansion, and renewal execution.
...
## Long-Term Vision
Establish a durable category-leading function for customer success operations, adoption expansion, and renewal execution that improves strategic velocity, reliability, and enterprise value.

## Ultimate Mission
Convert customer success operations, adoption expansion, and renewal execution into a structural competitive advantage for the company brain.
