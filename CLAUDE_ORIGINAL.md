# Koydo Worlds — Forked from The Loom Engine
...
github.com/robertwaltos/Koydo_Loom    ← Fork: Koydo Worlds (THIS REPO)
...
### What Stays in the Fork (Koydo Worlds only)
...
universe/           ← PRODUCT-SPECIFIC (Koydo Worlds only)
...
- `koydo-worlds-unified-bible-v3.docx` — Latest/comprehensive (vision, architecture, tech stack, characters, content, implementation)
- `koydo-worlds-realworld-bible-v2.docx` — Detailed real-world entries with full descriptions
- `koydo-worlds-realworld-bible.docx` — Original real-world entries (v1)
