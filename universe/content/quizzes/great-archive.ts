/**
 * Quiz Questions — The Great Archive (The Librarian)
...
export const GREAT_ARCHIVE_QUIZZES: readonly EntryQuizQuestion[] = [
  ...
  // ─── entry-great-library-alexandria ─────────────────────────────────────────
  {
    ...
    correctIndex: 1,
    explanation: 'The Library of Alexandria (~288 BCE) tried to collect every scroll ever written. Ships docking at Alexandria were searched, and any books found were copied — the library kept the originals. It also housed the Mouseion, history\'s first research institution.',
  },
  {
    ...
    options: [
      ...
      'The Library declined gradually over centuries due to underfunding and political neglect — not a single event',
  ...
  },
  {
    ...
    options: [
      ...
      'He calculated the circumference of the Earth — and was only 0.16% off',
      'He wrote the first atlas of the known world',
      'He invented longitude and latitude',
    ],
    correctIndex: 1,
    explanation: 'Eratosthenes (~240 BCE) knew that at noon on the summer solstice in Syene, the sun cast no shadow. In Alexandria, it cast a 7.2-degree shadow. Using geometry and the distance between cities, he calculated Earth\'s circumference at ~252,000 stades — within 0.16% of the actual number. He did this without satellites, only math and curiosity.',
  },
  ...
  // ─── entry-first-encyclopedia ────────────────────────────────────────────────
  {
    ...
    correctIndex: 2,
    explanation: 'Emperor Yongle of China\'s Ming Dynasty hired 2,169 scholars to write the Yongle Dadian (1408 CE). It took 6 years and produced 22,877 chapters in over 11,000 volumes — the most comprehensive encyclopedia ever assembled before the internet.',
  },
  {
    id: 'quiz-yongle-t2',
    entryId: 'entry-first-encyclopedia',
    ...
    correctIndex: 3,
    explanation: 'Of the original 11,095 volumes, only about 400 survive — roughly 3.5%. Most were destroyed during the Boxer Rebellion (1900). The surviving volumes are scattered across libraries on four continents. Each can sell for over $1 million at auction.',
  },
  {
    id: 'quiz-yongle-t3',
    entryId: 'entry-first-encyclopedia',
    ...
    options: [
      ...
      'A single physical copy of something important is extremely fragile — distributed storage is more resilient',
    ...
    correctIndex: 1,
    explanation: 'The Yongle Encyclopedia had few copies because reproducing it was enormously expensive. Compare this to the internet\'s design — ARPANET was specifically built WITH multiple nodes so no single destruction could erase it. The lesson of the Yongle Dadian directly echoes in modern backup strategies, cloud storage, and Wikipedia\'s distributed hosting.',
  },
  ...
  },
  {
    ...
    options: [
      ...
      'It had multiple nodes — if one was destroyed, signals rerouted through others',
      'It used paper backups for every digital message',
    ],
    correctIndex: 2,
    explanation: 'Unlike the Library of Alexandria (one building, one collection), ARPANET had no single point of failure. Information traveled in "packets" that could take different routes to reach the same destination. This distributed design made the network resilient — and it\'s why the internet today persists even when servers go down.',
  },
  {
    id: 'quiz-arpanet-t3',
    entryId: 'entry-internet-birth',
    ...
    options: [
      'Email — the ability to send personal messages',
      'HTTP and HTML — the ability to link documents together with clickable hyperlinks',
      'Search engines — the ability to find information easily',
      'Encryption — the ability to keep messages private',
    ],
    correctIndex: 1,
    explanation: 'Tim Berners-Lee invented HTTP (how computers request documents) and HTML (how documents are formatted and linked) in 1989–1991. His contribution was hyperlinks — documents could point to other documents anywhere on the network. The internet became a web of connected knowledge rather than a network of isolated files.',
  },
  ...
  // ─── entry-wikipedia ─────────────────────────────────────────────────────────
  {
    ...
    options: [
      ...
      'Anyone in the world could write the encyclopedia together — for free',
      'Every country would have its own encyclopedia online',
      'Scientists would create a verified fact database',
    ],
    correctIndex: 1,
    explanation: 'Wikipedia (launched January 15, 2001) was radical: a free encyclopedia written collaboratively by volunteers. It started with 20 articles. Today it has over 60 million articles in 300 languages — the largest encyclopedia ever assembled, built by people who were paid nothing.',
  },
  {
    ...
    options: [
      ...
      'Wikipedia can have bias, gaps, and errors — especially for underrepresented communities',
      'Wikipedia deletes old articles every year',
    ],
    correctIndex: 2,
    explanation: 'Wikipedia reflects who is doing the writing — and most editors have historically been white men from wealthy countries. This creates documented bias: women scientists are underrepresented, non-European histories have fewer articles, and some articles on minority communities contain errors. Knowing who writes a source is part of evaluating it.',
  },
  {
